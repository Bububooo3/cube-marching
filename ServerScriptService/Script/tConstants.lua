...
tConstants.cornerTable = {
	[0] = Vector3.new(1,0,0), -- 0
	[1] = Vector3.new(0,0,0), -- 1
	[2] = Vector3.new(1,1,0), -- 2
	[3] = Vector3.new(0,1,0), -- 3
	[4] = Vector3.new(0,0,1), -- 4
	[5] = Vector3.new(1,0,1), -- 5
	[6] = Vector3.new(1,1,1), -- 6
	[7] = Vector3.new(0,1,1) 	-- 7
}

tConstants.edgeTable = {
	[0] = {0, 1},
	[1] = {1, 2},
	[2] = {2, 3},
	[3] = {3, 0},
...
-- THATS RIGHT. I NUMBERED AAALLL OF THEM. ALLLLLLLL of it.
-- I used shift + alt + highlight/click (multi-select) and the line numbers to GREATLY hasten this endeavor 😏
tConstants.vertexTable = {
	[0] = {},
	[1] = {0, 8, 3},
	[2] = {0, 1, 9},
	[3] = {1, 8, 3, 9, 8, 1},
