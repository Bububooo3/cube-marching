...
function makeCyclePoints(area: Part): {number}
	...
	So it goes...
		...
		(0,0,1) - 2 :: Left Bottom Back
		(0,1,0) - 3 :: Left Top Front
		(0,1,1) - 4 :: Left Top Back
		(1,0,0) - 5 :: Right Bottom Front
		(1,0,1) - 6 :: Right Bottom Back
		(1,1,0) - 7 :: Right Top Front
...
--[[
	...
	lookup[3] = cyclePoints[0]
	lookup[0] = cyclePoints[1]
	lookup[7] = cyclePoints[2]
	lookup[4] = cyclePoints[3]
	lookup[2] = cyclePoints[4]
